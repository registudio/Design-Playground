...
const STEPS: { id: Step; label: string; icon: string; description: string }[] = [
  ...
  { id: "motion", label: "Motion & engines", icon: "≈", description: "Find your rhythm." },
];
...
export default function Playground() {
  ...
  useEffect(() => { if (workspace) setVisited(old => old.includes(step) ? old : [...old, step]); }, [workspace, step]);
  useEffect(() => { setVisited([]); }, [project?.id]);
